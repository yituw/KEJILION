...
elrepo() {
		  ...
		  echo "Linux 커널을 업그레이드하면 시스템 성능과 보안이 향상될 수 있습니다. It is recommended to try it if possible, and upgrade the production environment with caution!"
		  echo "------------------------------------------------"
		  read -e -p "계속하시겠습니까? (예/아니요):" choice
